...
for($i=1;$i<=12;$i++){
    ...
    //echo 'Query valor cuestionario: '.$sqlvar.'<br>';
...
//echo 'Query Eval servicios: '.$sqleval.'<br>';    
...
$sqltot2 = "SELECT COUNT(valor) FROM cuestionario WHERE (valor=0 || valor=5) AND identificador='$identificador' AND sucursal='$sucursal'";
...
$badge = $rowbadge[0];    
    ...
    $sucursales[] = array($sucarray[$i-1],$evalfinal,$badge);
